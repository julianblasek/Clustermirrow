...
rest=[]
rest.append(all_samples1[0])
rest.append(all_samples1[1])
rest.append(all_samples2[0])
rest.append(all_samples2[1])
green=[]
green.append(all_samples1[2])
green.append(all_samples2[2])
namesgrün=[r"Varying $m_{e}$: Run 2",r"$\Lambda$ CDM: Run 5"]
namesrest=[r"Varying $m_{e}$: Run 3",r"Varying $m_{e}$: Run 1",r"$\Lambda$ CDM: Run 6",r"$\Lambda$ CDM: Run 4"]
col1 = ["blue","red"]
col2 = ["blue","red","green","purple"]



plotter1 = gdplt.get_subplot_plotter()
plotter1.settings.figure_legend_loc=(0.49,0.82)
plotter1.settings.axes_labelsize=28
plotter1.settings.legend_fontsize=25
plotter1.settings.axes_fontsize=17
plotter1.triangle_plot(green, filled=True, legend_labels=namesgrün, contour_colors=col1)


plotter2 = gdplt.get_subplot_plotter()
plotter2.settings.figure_legend_loc=(0.5,0.8)
plotter2.settings.axes_labelsize=28
plotter2.settings.legend_fontsize=25
plotter2.settings.axes_fontsize=17
plotter2.triangle_plot(rest, filled=True, legend_labels=namesrest, contour_colors=col2)
...
plotter1.export("plots/short_nurgrün.pdf")
plotter2.export("plots/short_rest.pdf")
