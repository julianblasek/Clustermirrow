...
#SBATCH --output=/home/em632080/software/cobayafork/test2/output/mit_step_ohne_bbn.txt             
...
$MPIEXEC -n 10 $FLAGS_MPI_BATCH python step3.py                
