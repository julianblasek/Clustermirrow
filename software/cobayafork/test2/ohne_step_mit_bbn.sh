...
#SBATCH --output=/home/em632080/software/cobayafork/test2/output/ohne_step_ohne_Li.txt             
...
$MPIEXEC -n 10 $FLAGS_MPI_BATCH python ohne_step.py                
