...
info = {
    #Chain Pfad
    "output":os.path.expanduser("~/cobaya/test2/raw4/chains/"), #mit BBN
    #"output":os.path.expanduser("~/cobaya/test2/raw2/chains/"), #ohne BBN
    "debug":False,
    "test":False,
    "stop_at_error":False,
    "timing":True,
    ...
    "theory": {
        ...
        "path":"/home/em632080/class/raw1/class_public" #mit BBN
        #"path":"/home/em632080/class/raw2/class_public" #ohne BBN
        },
    },
    "likelihood": {
    ...
    "sampler": { 
        "mcmc": {
            ...
            "Rminus1_stop": 0.01,
            "max_tries": 24000,
            "covmat": os.path.expanduser("/home/em632080/software/cobayafork/test2/covmats/lcdm.covmat"), #ohne Step
            },
        },
