...
#SBATCH --output=/home/em632080/software/cobayafork/test2/output/mit_step_ohne_D_HE.txt             
...
$MPIEXEC -n 10 $FLAGS_MPI_BATCH python step2.py                
